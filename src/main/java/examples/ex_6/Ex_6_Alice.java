    ...
    public static void main(String[] args) {
        CrolangP2PJvm.Java.connectToBroker(
                ...
                () -> {
                    ...
                    targets.put(Constants.BOB_ID, JavaOutgoingCrolangNodeCallbacks.builder().build());
                    targets.put(Constants.CAROL_ID, JavaOutgoingCrolangNodeCallbacks.builder().build());
                            ...
                            (successes, errors) -> {
                                CrolangP2PJvm.Java.getConnectedNode(
                                        ...
                                        node -> node.ifPresent(n -> {
                                            ...
                                            n.send("GREETINGS_CHANNEL", "Hello " + n.getId() + "!");
                                        })
                                );
