...
- [Sub-examples](#sub-examples)
    - [4A: Single node, synchronous](#4a-single-node-asynchronous)
    - [4B: Multiple nodes, synchronous](#4b-multiple-nodes-asynchronous)
...
- `Ex_4_A_Alice.java`: Alice implementation for single asynchronous node connection.
- `Ex_4_B_Alice.java`: Alice implementation for multiple asynchronous nodes connection.
